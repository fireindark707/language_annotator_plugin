(function (global) {
	...
	function translateSelection(text, deps) {
		...
		}).catch(function (e) { console.error(_dbg, "outer catch:", e); onError(e); });
	}
		...
		return new Promise(function (resolve) {
			try {
				...
				chromeI18n.detectLanguage(text || "", function (result) {
					if ((chromeRuntime && chromeRuntime.lastError) || !result || !Array.isArray(result.languages) || !result.languages[0]) { resolve(""); return; }
