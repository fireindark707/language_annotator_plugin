(function (global) {
	...
	const previewTranslateQueue = (global.TranslationUtils && typeof global.TranslationUtils.createTaskQueue === "function")
		? global.TranslationUtils.createTaskQueue(PREVIEW_TRANSLATE_CONCURRENCY)
		: null;
	...
	function queuePreviewTranslation(sentence, targetEl, deps) {
		...
		const enqueue = previewTranslateQueue || ((job) => Promise.resolve().then(job));
		enqueue(async () => {
