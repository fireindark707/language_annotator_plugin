		...
		style.textContent = `
			.la-addword-overlay {
				...
				.la-addword-modal {
					...
					background: linear-gradient(180deg, rgba(255, 251, 245, 0.98), rgba(255, 246, 238, 0.98));
			...
			.la-addword-word {
				...
				.la-addword-lemma {
					...
					padding: 8px 10px;
					border: 0;
					border-left: 2px solid #dcc8b8;
					border-radius: 0 12px 14px 10px;
					background: linear-gradient(180deg, rgba(255, 248, 241, 0.96), rgba(250, 241, 231, 0.88));
					display: flex;
					align-items: center;
			...
			.la-addword-dict-section-title {
				...
				.la-addword-dict-item {
					...
					column-gap: 10px;
					border: 0;
					border-bottom: 1px dashed #ded0c3;
					border-radius: 0;
					background: transparent;
					padding: 7px 2px;
				}
				.la-addword-dict-item:last-child {
					border-bottom: 0;
				}
				.la-addword-dict-item.is-selected {
					border-bottom-color: #a55143;
					box-shadow: inset 0 -2px 0 rgba(165, 81, 67, 0.18);
				}
